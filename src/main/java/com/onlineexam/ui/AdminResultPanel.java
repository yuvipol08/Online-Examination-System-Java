...
/**
 * Admin screen that shows the result of every attempt written by any
 * student. Selecting a row and clicking View Answer Sheet opens the
 * full question by question sheet of that attempt.
 */
public class AdminResultPanel extends JPanel {
    ...
    private final DefaultTableModel tableModel = new DefaultTableModel(
            new String[]{"Result ID", "Student", "Roll No", "Exam", "Date",
                         "Attempted", "Correct", "Marks", "Percentage", "Status"}, 0) {
        @Override
    ...
    public AdminResultPanel() {
        ...
        add(UITheme.createTitleLabel("EXAMINATION RESULTS"), BorderLayout.NORTH);
    ...
    private JScrollPane buildTable() {
        ...
        int[] widths = {50, 145, 65, 155, 125, 75, 60, 70, 75, 55};
    ...
    /** Reads every result of every student into the table. */
    public void loadResults() {
        try {
            ...
            summaryLabel.setText("Total attempts : " + results.size()
                    + "        Passed : " + passed
    ...
    private void doViewAnswerSheet() {
        ...
        try {
            ...
            new ResultDialog(parent, result, true).setVisible(true);
